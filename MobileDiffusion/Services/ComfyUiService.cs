...
using MobileDiffusion.Services.ComfyUi;
using MobileDiffusion.ViewModels;
using Microsoft.Kiota.Abstractions.Authentication;
using Microsoft.Kiota.Http.HttpClientLibrary;
using Newtonsoft.Json.Linq;
using PromptRequest = MobileDiffusion.Clients.ComfyUi.Models.PromptRequest;
using PromptRequest_prompt = MobileDiffusion.Clients.ComfyUi.Models.PromptRequest_prompt;
