...
namespace Mogri.Platforms.iOS.Coordinators;

/// <summary>
/// Coordinates iOS generation execution inside a background task so work can continue when the app backgrounds.
/// </summary>
public class IosGenerationTaskCoordinator : IGenerationTaskCoordinator
{
    ...
    public IosGenerationTaskCoordinator(
